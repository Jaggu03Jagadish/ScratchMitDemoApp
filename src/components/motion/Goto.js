...
const GotoXY = ({ character, comp_id }) => {
  ...
  return (
    <Paper elevation={3}>
      <div className="text-center rounded bg-blue-500 p-2 my-3" style={{backgroundColor:"lightblue"}}>
        <div className="grid grid-cols-2 my-2" style={{backgroundColor:"lightblue"}}>
        ...
        <div
          ...
          onClick={() => gotoXY()} style={{backgroundColor:"lightblue"}}
        >
