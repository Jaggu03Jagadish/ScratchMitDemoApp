          ...
          return (
            <div className="w-60" key={l.id}>
              <Paper elevation={3} className="p-4">
                <div className="w-52 border border-2 border-gray-300 p-2" style={{backgroundColor:"#0073e6"}}>
                  <Droppable droppableId={l.id} type="COMPONENTS">
                    {(provided) => {
                      return (
                        ...
                        >
                          <div className="text-center mx-auto my-2 mb-4" style={{backgroundColor:"#0073e6"}}> 
                            <RunButton
                              variant="contained"
                              className={classes.button}
